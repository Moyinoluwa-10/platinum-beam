    ...
    <section className="p-5 pt-5 md:pt-24 pb-24 container flex flex-col lg:flex-row gap-12 justify-between items-center">
      ...
      <div className="lg:max-w-xl">
        ...
        <p className="text-xl md:text-2xl mb-10">
          ...
          to new heights of cleanliness and luxury.Get in touch with us today to
          learn how our team can help you clean and de-clutter. Choose from any
          of our three cleaning plans designed to cater to your lifestyle.
        </p>
        <div>
          <Link
            to={"/book"}
