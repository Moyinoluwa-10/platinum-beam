        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
          ...
          <div className="lg:max-w-xl">
            <p className="text-xl md:text-2xl mb-10">
              ...
              Platinum Beam Concept Ltd. She is a connoisseur of transformative
              spaces and advocate for the art of sophistication in our daily
              lives. Her commitment is about more than just aesthetics; it's a
              mission to inspire and influence a lifestyle that cherishes
              excellence, leadership, and balance. At Platinum Beam Concept,
              they don't just clean; They Enhance, Elevate, and Transform. Join
              her in redefining what it means to live and work in spaces that
              not only look pristine but feel truly luxurious.
            </p>
          </div>
        </div>
      </section>
